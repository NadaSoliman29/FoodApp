  ...
  let deleteRecipes = async () => {
    try {
      let response = await axios.delete(
        `https://upskilling-egypt.com:3006/api/v1/Recipe/${itemId}`,
    ...
    <>
      ...
      <div className="title d-flex justify-content-between p-3 align-items-center">
        ...
        {loginData?.userGroup == "SuperAdmin" ? (
          <Link
            to={"/dashboard/recipes-data/Add-recipe"}
            className="btn btn  text-white btncolor"
          >
            {" "}
            Add New Recipe{" "}
          </Link>
      ...
      <div className="data p-3">
        ...
        ) : respiesList.length > 0 ? (
          <div className="table-wrap rounded-4 overflow-hidden ">
                  ...
                  <tr className=" text-center" key={item.id}>
                    ...
                    <td>
                      {item.imagePath ? (
                        ...
                        <img className="table-img" src={NoRecipesImg} alt="" />
                      )}
                    </td>
                    ...
                    <td className="text-end">
                      <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end shadow-sm rounded-3 py-2">
                          <li>
                            <Link
                              to={`/dashboard/recipes-data/${item.id}?mode=view`}
                              className="dropdown-item d-flex align-items-center gap-2"
                            >
                              <i className="fa-regular fa-eye maincolor"></i>{" "}
                              View
                            </Link>
                          </li>
                          {loginData?.userGroup == "SuperAdmin" ? (
                            <div>
                              ...
                              <li>
                                <button
                                  ...
                                  className="dropdown-item d-flex align-items-center gap-2 "
                                >
                                  <i className="fa-regular fa-trash-can maincolor"></i>{" "}
                                  Delete
                                </button>
                              </li>
                            </div>
